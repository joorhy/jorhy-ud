...
import wx.xrc
import wx.dataview
from app.logic.printer_setting.CDataSchemeType import CDataSchemeType

class CModelSchemeType(wx.dataview.PyDataViewModel):
    ...
    def GetValue(self, item, col):
        ...
        if isinstance(node, CDataSchemeType):
            mapper = {  0 : node.id,
                        1 : node.code,
                        2 : node.name,
                     }
