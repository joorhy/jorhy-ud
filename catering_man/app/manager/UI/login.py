...
class WgtLogin(wx.Panel):
    ...
    def Initailize(self):
        # Add event listener
        EvtManager.AddListener(self, EnumEvent.EVT_LOGIN, self.OnEvtLogin)
        
        self.GetParent().SetTitle(u"登陆")

    def Uninitailize(self):
        # Remove event listener
        EvtManager.RemoveListener(self, EnumEvent.EVT_LOGIN, self.OnEvtLogin)
