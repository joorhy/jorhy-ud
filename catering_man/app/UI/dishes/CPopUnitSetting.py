...
from app.logic.dishes.CModelUnit import CModelUnit
from app.logic.dishes.CDataUnit import CDataUnit
...
class CPopUnitSetting ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        ...
        self.model = CModelUnit(CDataUnitInfo.GetData())
        ...
        self.m_dataViewListName = self.m_dataViewList.AppendTextColumn( u"菜品单位", 2, width=-1, mode=wx.dataview.DATAVIEW_CELL_EDITABLE ) 
    ...
    def OnBtnNew( self, event ):
        event.Skip()
        CDataUnitInfo.AddItem(CDataUnit(0, 0, ""))
        
        data = CDataUnit(CDataUnitInfo.GetDataLen() + 1, CDataUnitInfo.GetId(), "")
    ...
    def OnBtnDelete( self, event ):
        ...
        CDataUnitInfo.DeleteItem(data)
    
    def OnBtnRefresh( self, event ):
        event.Skip()
        
        result = CDataUnitInfo.GetData()
