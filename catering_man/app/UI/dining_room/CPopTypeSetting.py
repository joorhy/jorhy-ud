...
class CPopTypeSetting ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        ...
        self.model = CModelType(CDataTypeInfo.GetData())
        ...
        self.m_dataViewListName = self.m_dataViewList.AppendTextColumn( u"桌类名称", 2, width=-1, mode=wx.dataview.DATAVIEW_CELL_EDITABLE ) 
    ...
    def OnBtnNew( self, event ):
        event.Skip()
        CDataTypeInfo.AddItem(CDataType(0, 0, ""))
        
        data = CDataType(CDataTypeInfo.GetDataLen() + 1, CDataTypeInfo.GetId(), "")
    ...
    def OnBtnDelete( self, event ):
        ...
        CDataTypeInfo.DeleteItem(data)
    
    def OnBtnRefresh( self, event ):
        event.Skip()
        
        result = CDataTypeInfo.GetData()
