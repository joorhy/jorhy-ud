...
from app.logic.dining_room.CModelArea import CModelArea
...
class CPopAreaSetting ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        ...
        self.model = CModelArea(CDataAreaInfo.GetData())
        ...
        self.m_dataViewListName = self.m_dataViewList.AppendTextColumn( u"区域名称", 2, width=-1, mode=wx.dataview.DATAVIEW_CELL_EDITABLE ) 
    ...
    def OnBtnNew( self, event ):
        event.Skip()
        CDataAreaInfo.AddItem(CDataArea(0, 0, ""))
        
        data = CDataArea(CDataAreaInfo.GetDataLen() + 1, CDataAreaInfo.GetId(), "")
